...
class E01DescribeTheStrings
{
    static void Main ()
    {
        // Describe the strings in C#. What is typical for the string data type? Describe the most important 
        ...
        Console.WriteLine ("Join(String, Object[]) - Concatenates the elements of an object array, using the" + 
                            "specified separator between each element.");
        Console.WriteLine ("Split(Char[]) - Returns a string array that contains the substrings in this instance" + 
