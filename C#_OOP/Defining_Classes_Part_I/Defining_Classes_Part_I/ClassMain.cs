...
namespace Defining_Classes_Part_I
{
    class ClassMain
    {
        static void Main ()
        {
             ...
             *      battery characteristics (model, hours idle and hours talk) and display characteristics (size and number 
             *      of colors). Define 3 separate classes (class GSM holding instances of the classes Battery and Display).
             *      2. Define several constructors for the defined classes that take different sets of arguments (the full
             *      information for the class or part of it). Assume that model and manufacturer are mandatory (the others 
             ...
             *      5. Use properties to encapsulate the data fields inside the GSM, Battery and Display classes. Ensure 
             *      all fields hold correct data at any given time.
             ...
             *      9. Add a property CallHistory in the GSM class to hold a list of the performed calls. Try to use 
             *      the system class List<Call>.
             *      10. Add methods in the GSM class for adding and deleting calls from the calls history. Add a 
