namespace E01Homework
{
    ...
    public enum Faculty
    {
        Automation, Mathematics, Phisics, Management, IT_technology
    }
 
    public enum Specialty
    {
        Telecommunications, MedicineMarketing, IT_management,
        Phisics, Mathematics, Informatics, Law, Philosophy
    }
    ...
    public class Student : ICloneable, IComparable<Student>
    {
        ...
        public Student (string firstName, string middleName, string lastName, string ssn, string permanentAddress,
            string mobilePhone, string e_mail, string course, University university, Faculty faculty, Specialty specialty)
        {
        ...
        public override string ToString ()
        {
            ...
            "Faculty: {9}\r\nSpecialty: {10}\r\n",
                ...
                this.E_mail, this.Course, this.University, this.Faculty, this.Specialty);
        }

        public Student Clone ()
        {
            Student cloneStudent = new Student (this.FirstName, this.MiddleName, this.LastName, this.SSN, this.PermanentAddress,
                                this.MobilePhone, this.E_mail, this.Course, this.University, this.Faculty, this.Specialty);
