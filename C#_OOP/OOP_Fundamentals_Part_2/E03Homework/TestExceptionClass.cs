namespace E03Homework
{
    ...
    class TestExceptionClass
    {
        ...
        static void Main ()
        {
            ...
            {
                Console.WriteLine ("{0}\nRange: [{1} - {2}]", ire.Message, ire.Start.ToString (DATE_FORMAT), ire.End.ToString (DATE_FORMAT));
            }
        ...
        static int GetInteger (int start, int end) 
        {                                     
            int number;
            bool isNumber = false;
            ...
            do
            {
                Console.Write ("Please, enter an integer in the range [{0}...{1}]: ", start, end);
