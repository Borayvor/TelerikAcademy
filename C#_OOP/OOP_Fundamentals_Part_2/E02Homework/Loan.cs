namespace E02Homework
{
    ...
    {
        public Loan (Customer owner, decimal balance, decimal monthlyInterestRate, ushort numberOfMonths)
        ...
        public override decimal CalculateInterestAmount ()
        {
            if (this.Owner is IndividualCustomer)
            {
                ...
                {
                    return base.CalculateInterestAmount () - (3 * this.MonthlyInterestRate * this.Balance);
                }
                return 0;
            }
            else if (this.Owner is CorporateCustomer)
            {
                ...
                {
                return base.CalculateInterestAmount () - (2 * this.MonthlyInterestRate * this.Balance);
                }
                return 0;
            }
            else
