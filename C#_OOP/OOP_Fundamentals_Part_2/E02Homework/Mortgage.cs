namespace E02Homework
{
    ...
    {
        public Mortgage (Customer owner, decimal balance, decimal monthlyInterestRate, ushort numberOfMonths)
        ...
        public override decimal CalculateInterestAmount ()
        {
            if (this.Owner is IndividualCustomer)
            {
                ...
                {
                    return base.CalculateInterestAmount () - (6 * this.MonthlyInterestRate * this.Balance);
                }
                return 0;
            }
            else if (this.Owner is CorporateCustomer)
            {
                ...
                {
                    return base.CalculateInterestAmount () - ((12 * this.MonthlyInterestRate * this.Balance) / 2);
                }
