namespace InheritanceAndPolymorphism
{
    ...
    public abstract class Course : ICourse
    {
        ...
        protected Course(string courseNameInitial, string teacherNameInitial, IList<string> studentsInitial)
        {
        ...
        public string CourseName
        {
            ...
            set
            {
                CheckValueForException(value, "CourseName");
        ...
        public string TeacherName
        {
            ...
            set
            {
                //CheckValueForException(value, "TeacherName");
        ...
        protected void CheckValueForException(string value, string valueName)
        {
            ...
            {
                throw new ArgumentException(" " + valueName + " cannot be null, empty or white-space !");
            }
        }
    }
}
